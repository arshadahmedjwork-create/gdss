    ...
    try {
      const { error } = await supabase
        ...
        .insert([{
          ...
          message: `[Preferred callback: ${form.timeSlot || "Not selected"} - ${form.timezone}]\n${form.message}`,
          status: 'pending'
        }]);
          ...
          <div className="mx-auto max-w-2xl">
            ...
            {submitted ? (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="border border-primary/30 bg-primary/5 p-12 text-center">
                ...
                <p className="mt-3 text-muted-foreground">We will confirm your appointment via email, phone, or WhatsApp within 12 hours.</p>
              </motion.div>
            ) : (
              <motion.form 
              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <select required value={form.timezone} onChange={e => setForm({...form, timezone: e.target.value})} className={inputClass}>
