...
const navLinks = [
  { label: "Home", path: "/" },
  {
    ...
    children: [
      ...
      { label: "Insurance Fraud", path: "/services/insurance-fraud" },
      { label: "Due Diligence", path: "/services/due-diligence" },
      { label: "Matrimonial Verification", path: "/services/matrimonial" },
      { label: "NRI Verification", path: "/services/nri-verification" },
    ],
  },
      ...
      >
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
            ...
            {navLinks.map((link) =>
              link.children ? (
                ...
                >
                  ...
                  <Link
                    to={link.path}
                    className={`nav-link-hover font-body text-sm font-medium tracking-wide transition-colors hover:text-primary ${
          ...
          <div className="hidden items-center gap-4 lg:flex">
            <label className="flex items-center gap-2 border border-border bg-background/50 px-3 py-2 text-xs font-bold text-foreground">
            ...
            <div className="flex flex-col items-end mr-4 border-r border-border pr-4">
              <span className="text-xs text-muted-foreground uppercase tracking-wider font-semibold">24/7 Emergency</span>
              <a href="tel:+919999999999" className="flex items-center gap-1.5 text-sm font-bold text-destructive hover:text-destructive/80 transition-colors">
            ...
            <Link
              to="/inquiry"
              className={`bg-primary text-primary-foreground hover:bg-primary/90 px-5 py-2.5 text-sm font-medium rounded transition-colors ${location.pathname === "/inquiry" ? "ring-2 ring-primary ring-offset-2" : ""}`}
            >
