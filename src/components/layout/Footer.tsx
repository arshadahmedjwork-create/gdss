  ...
  return (
    <footer className="border-t border-border/30 bg-card/30">
      <div className="container mx-auto px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2.5">
              <Link to="/services/corporate" className="text-sm text-muted-foreground hover:text-primary transition-colors">Corporate Investigations</Link>
              <Link to="/services/background-verification" className="text-sm text-muted-foreground hover:text-primary transition-colors">Background Verification</Link>
              <Link to="/services/insurance" className="text-sm text-muted-foreground hover:text-primary transition-colors">Insurance Investigation</Link>
              <Link to="/services/private" className="text-sm text-muted-foreground hover:text-primary transition-colors">Private Investigation</Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Link to="/inquiry" className="text-sm text-muted-foreground hover:text-primary transition-colors">Confidential Inquiry</Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="mailto:info@gdssinvestigations.com" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
        ...
        <div className="mt-12 border-t border-border/30 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
